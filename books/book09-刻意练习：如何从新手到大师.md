...
想要提高个人实力，需要辨认并拒绝三种流行的错误思想：
	...
	所以本文要做的就是矫正这两种思想，即：每个人都有成为某个领域高手的潜力，你只有在在足够长的时间里做大量的正确的联系。关键词缺一不可。
```
...
特点3:及时反馈可以帮助你调整思路、行进方向

- 有目的的练习包含反馈



特点2:专注 focus on the working task，do not care about the results
